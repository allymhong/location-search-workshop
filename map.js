...
JF.initialize({ apiKey: "68ed4c0b7a6981d677c5e81febfc4f8e" });

// mapbox access token
mapboxgl.accessToken =  "pk.eyJ1IjoiYWxseW1pbmp1IiwiYSI6ImNsOXd0eGZ1cDA0NTIzcW41cnU0YzV2ZGoifQ.JwTImbn-rdOcGDY-c7MPZw";
...
const map = new mapboxgl.Map({
  ...
  style: "mapbox://styles/allyminju/cl9wu7nse007714n79ngmy9d7", // Map style to use
...
function getSubmissions() {
  JF.getFormSubmissions("223257626598064", function (responses) {
...
map.on("click", (e) => {
  ...
  const updateDescription = (location) => {
    ...
    // email
    submission[7] = newPoint.properties.email;
    // place name
    submission[8] = newPoint.properties.placeName;
    // latitude
    submission[10] = newPoint.geometry.coordinates[1];
    // longitude
    submission[9] = newPoint.geometry.coordinates[0];
    // description
    submission[11] = newPoint.properties.description;
